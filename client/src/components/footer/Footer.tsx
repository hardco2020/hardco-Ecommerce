  ...
  return (
    <Container>
      <Left>
        <Logo>HardCo.</Logo>
        <Desc>
          There are many variations of products available, if you want to have
          the best buying experience , you must buy at hardco-ecommerce Their
          are a lot of products on sale now. Let's see it !
        </Desc>
        <SocialContainer>
